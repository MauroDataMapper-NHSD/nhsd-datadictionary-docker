...
Next steps, some optional, some because this script isn't going to do all
the work for you:

  1. If you are one of the users which has just been added to the
     docker and id groups you will need to re-login for the change to
     take effect.
  2. Set the `hostname` for this server.
...
#
# server {
#     server_name mauro.uat.dataproducts.nhs.uk; # managed by Certbot
#
#     listen [::]:443 ssl ipv6only=on; # managed by Certbot
#     listen 443 ssl; # managed by Certbot
#
#     ssl_certificate /etc/letsencrypt/live/mauro.uat.dataproducts.nhs.uk/fullchain.pem; # managed by Certbot
#     ssl_certificate_key /etc/letsencrypt/live/mauro.uat.dataproducts.nhs.uk/privkey.pem; # managed by Certbot
